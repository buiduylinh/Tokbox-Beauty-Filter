...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, SeekBar.OnSeekBarChangeListener {
    ...
    private MirrorVideoCapturer mirrorVideoCapturer;
    ...
    private Session.SessionListener sessionListener = new Session.SessionListener() {
        ...
        public void onConnected(Session session) {
            ...
            mirrorVideoCapturer = new MirrorVideoCapturer(MainActivity.this);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            case R.id.seekBarBeauty:
                mirrorVideoCapturer.setBeautyLevel(progress);
                break;
            case R.id.seekBarTone:
                mirrorVideoCapturer.setToneLevel(progress);
                break;
        }
    }
